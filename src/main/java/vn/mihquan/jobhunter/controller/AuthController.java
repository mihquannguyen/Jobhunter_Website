...
import vn.mihquan.jobhunter.domain.request.ReqLoginDTO;
import vn.mihquan.jobhunter.domain.response.ResCreateUserDTO;
import vn.mihquan.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
        ...
        public ResponseEntity<ResLoginDTO> login(@Valid @RequestBody ReqLoginDTO loginDTO) {
                ...
                // set thông tin người dùng đăng nhập vào context (có thể sử dụng câu sau này)
