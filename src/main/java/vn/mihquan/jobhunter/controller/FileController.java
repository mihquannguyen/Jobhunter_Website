...
import vn.mihquan.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.mihquan.jobhunter.service.FileService;
import vn.mihquan.jobhunter.util.annotation.ApiMessage;
import vn.mihquan.jobhunter.util.error.StorageException;
